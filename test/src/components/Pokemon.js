      ...
      <StyledPokemon filter={props.contrast} visibility={props.visibility}>
         ...
         <div>
            ...
            <p data-testid="pokemon">
               ...
               <br />
               {translations[locale]["types"]}:{" "}
               {translations[locale][props.pokemon.primarytype]}
               {comma} {translations[locale][props.pokemon.secondarytype]}
               <br />
               {translations[locale]["gender"]}:{" "}
               {translations[locale][props.pokemon.gender]}
               <br />
               hp: {props.pokemon.hp}
               <br />
